...
const Footer = () => {
  return (
    <footer className='bg-neutral-900 border-t-[1px] border-neutral-700 text-white/90 text-sm px-5 pt-12 pb-[150px] md:pb-[122px] flex justify-center items-center md:items-end md:min-h-[512px]'>
      <div className='relative w-full flex flex-col gap-1 justify-center items-start md:h-full'>
        <div className='flex flex-col md:flex-row gap-8  md:h-full'>
          <div className='h-full md:w-1/2 md:ml-4'>
          ...
          <div className='hidden md:block relative md:absolute md:bottom-0 md:right-0'>
            <div className=''>
              <WaterDropGridSmall />
            </div>
          </div>
